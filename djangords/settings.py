"""
Django settings for djangords project.
...
SECRET_KEY = 'django-insecure-q(=tvu_4&(hym%^+*wk*!8ho3vj1*^9xyhg6c@1oxv3*&1rm2o'
...
WSGI_APPLICATION = 'djangords.wsgi.application'
